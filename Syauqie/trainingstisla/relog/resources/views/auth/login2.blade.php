...
@section('main')
    <form class="form" action="{{ route('login') }}" method="POST">
        ...
        <div class="inputForm">
            ...
            <input placeholder="Enter your Email" name="email" class="input @error('email') is-invalid @enderror" type="text" value="{{ old('email') }}">
            @error('email')
        ...
        <div class="inputForm">
            ...
            <input placeholder="Enter your password" name="password" class="input @error('password') is-invalid @enderror" type="password" value="{{ old('password') }}">
            @error('password')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="flex-row">
            <div>
                <input type="radio" id="remember-me" name="remember">
                <label>Remember me </label>
            </div>
            <span class="span">Forgot password?</span>
        </div>
        <button type="submit" class="button-submit">Sign In</button>
        <p class="p">Don't have an account? <a href="{{ route('register') }}"><span class="span">Sign Up</span></a>
...
@push('scripts')
    ...
    <link rel="stylesheet" href="{{ asset('css/loginai.css') }}">
